...
struct DataManager {
    ...
    let appHudID: String = "app_KLek63Taw1QU7LLLU4JRjpicscerWW"
    let metricaID: String = "8505bc05-57fd-4b02-bf67-df57c57abeb9"
    let oneSignalID: String = "15d99035-2816-454b-9000-12082efd70e3"
    
    let codeTech: String = "is_unverified"
    
    let server1_0: String = "quixoz.space/app/fooorreytforx"
    let usagePolicy: String = "https://docs.google.com/document/d/1NxGtdhxlaJePzCry0z44xvIYL3dtIuzIX3PS43qoswo/edit?usp=sharing"
}
